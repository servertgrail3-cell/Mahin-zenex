...
BOT_TOKEN = "8527529958:AAHd_9vhd3HloqYGHDFnfCT4VSp-gmYXSNY"
API_KEY = "ZNX_MDY7VM9TJB90OHLVOP4EWTQ5"  # জেনেক্স এপিআই কী
...
WELCOME_MESSAGE = "✨ <b>WELCOME TO MANUAL PRO BOT</b> ✨\n━━━━━━━━━━━━━━━━━━━━━━\n🚀 <b>START INSTANT OTP RECEPTION NOW!</b> 🚀"
...
def load_settings():
    if not os.path.exists(SETTINGS_FILE):
        default = {
            ...
            "otp_group_url": "https://t.me/manualprootp1",
            "channel_url": "https://t.me/manualprobuyer",
            "support_username": "@Follower_x_Admin",
            ...
            "force_join_channels": ["https://t.me/manualprobuyer"], # ফোর্স জয়েন চ্যানেলসমূহ
    ...
    try:
        ...
        return {
            ...
            "force_join_channels": ["@manualprobuyer"],
...
async def support_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/Follower_x_Admin", style="primary")]
    ])
                    ...
                    if (num in active_numbers and 
                        ...
                        user_otp_keyboard = InlineKeyboardMarkup([
                            ...
                            [
                                ...
                                InlineKeyboardButton("✔️ NUMBER ↗", url="https://t.me/Follower_x_Admin", style="primary")
                            ]
                        ])
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                InlineKeyboardButton("‼️ Developer", url="https://t.me/Follower_x_Admin", style="danger"),
                                InlineKeyboardButton("📢 CHANNEL", url=channel_url, style="primary")
                            ]
                        ])
